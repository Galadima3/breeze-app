...
class SearchForecastTile extends ConsumerWidget {
  final String searchTerm;
  const SearchForecastTile({super.key, required this.searchTerm});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Consumer(builder: (context, ref, child) {
      final forekast = ref.watch(searchDailyForecastProvider(searchTerm));
